...
- [ ] AC-PAC-05: 承認、公開、予算、実行条件を版管理して変更できる。
- [ ] AC-PAC-06: ジョブ再実行で二重課金・二重公開が発生しない。
- [ ] AC-PAC-07: 推薦設定変更の対象と予測影響を適用前に確認できる。
- [ ] AC-PAC-08: 品質・生成設定の劣化を検証し公開を阻止できる。
- [ ] AC-PAC-09: 支援操作で秘密情報・本文全文・プロンプト全文が表示されない。
