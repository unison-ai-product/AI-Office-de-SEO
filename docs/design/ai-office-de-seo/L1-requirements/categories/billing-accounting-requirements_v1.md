...
|---|---:|---:|---|
| Entry | 39,800円 | 43,780円 | セルフ申込 |
| Standard | 98,000円 | 107,800円 | セルフ申込 |
| Prime | 198,000円 | 217,800円 | 問い合わせ・個別提案 |
| Enterprise | 398,000円〜 | 437,800円〜 | 問い合わせ・個別見積 |
...
Entryは1か月単位で契約できる。Standard、Prime、Enterpriseは最低利用期間を6か月とする。12か月契約はシステム利用料を10%割引し、追加credit、初期設定、個別導入、コンサルティング、オプション、従量利用は割引対象外とする。年契約の途中解約、更新、Plan変更、未使用creditの扱いは契約前に表示し、割引と別キャンペーンの併用可否をPrice Catalogへ持つ。

Prime以上はセルフ決済で即時開通せず、問い合わせから対象Site、組織規模、移行・接続、初期設定、運用体制、必要支援を確認して見積・契約する。EntryとStandardはセルフ導入を基本とし、有償の導入支援を別商品として追加できる。
...
- [ ] AC-L1-BILLING-02: Entry月単位、Standard以上6か月、年契システム利用料10%割引およびPrime以上の問い合わせ契約を再現でき、内部契約と外部Subscriptionの状態差を検出して未検証Webhookで利用権限が直接変更されない。
