...
- `記事制作`: LLMによる新規記事、リライト、画像・装飾の生成・編集、完成記事・差分・品質結果の確認、差し戻し、承認、CMS下書きDelivery、予約・公開を行う。初期WordPress AdapterではWordPress下書きへ送信する。人間の執筆担当・検収担当を別権限または必須割当として設けない。
