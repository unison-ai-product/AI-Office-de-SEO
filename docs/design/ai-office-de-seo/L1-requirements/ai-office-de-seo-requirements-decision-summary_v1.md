...
- 個人・小規模利用向けは最低品質・最小creditを含む月額19,800円（税込）のEntry Planを企画基準値とする。一般消費者も申込み可能な公開価格は総額表示とし、法人向け見積・請求で税額を分離する場合も支払総額を確認可能にする。標準記事1件当たり原価は約350円を仮説とし、実装・β実測後に記事枠と販売価格を確定する。
