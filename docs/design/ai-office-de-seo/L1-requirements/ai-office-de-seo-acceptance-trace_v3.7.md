...
- [ ] AC-L1-ACCESS-15: 顧客の3基本権限・業務タグと内部Roleが分離され、Owner／AdminやFeature Flagでtenant・Membership境界を上書きできない。 ｜ 検証: REQ-ACCESS-15 ｜ 正本: `categories/security-access-requirements_v1.md`
